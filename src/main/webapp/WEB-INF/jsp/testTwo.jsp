...
<div>
    ...
    <a href="<%=request.getContextPath() %>/ureport/pdf?_u=file:bing.ureport.xml">导出PDF格式报表</a>
    <p></p>
    <%
        ExportManager  exportManager=(ExportManager)Utils.getApplicationContext().getBean(ExportManager.BEAN_ID);
        Map<String,Object> parameters=new HashMap<String,Object>();
        HtmlReport htmlReport = exportManager.exportHtml("file:bing.ureport.xml",request.getContextPath(),parameters);
//输出Css样式
...
<div>
    <button style="width: 100px;">点击</button>
</div>
